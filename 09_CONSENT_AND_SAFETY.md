...
|---|---|---|
| **Paper study consent** | Volunteer (or guardian) + worker + study team | `legal/consent_form_en.md`, `legal/consent_form_te.md`, `legal/consent_form_hi.md`. Printed. Not in the app. |
