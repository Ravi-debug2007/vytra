...
| T-DIS-01 | S08 pumped at 360×640, `te`, `hi`, and `en`, every risk pair including dual HIGH | `disclaimerFull` visible, `fontSize >= 12`, no overflow exception |
...
| T-L10N-01 | Every key in `app_en.arb` exists in `app_te.arb` and `app_hi.arb` | exact |
...
| M-SAFE-01 | Read S08 aloud in `en`, `te`, and `hi`. | Matches `disclaimerFull` character for character. |
